...
public class StaticXsdTest {
    ...
    public void shoudLoadTheStaticXsdVersion() throws SAXException {
        XSDValidator xsdValidator = new XSDValidator( new File( this.getClass().getResource("/converterdata/converter-cen-fattpa/xsdstatic/Schema_del_file_xml_FatturaPA_versione_1.2.xsd").getFile() ) );
