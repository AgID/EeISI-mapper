...
public class LineConverterTest {
    ...
    private void populateWithBG20() {
        ...
        allowances.getBT0095DocumentLevelAllowanceVatCategoryCode().add(new BT0095DocumentLevelAllowanceVatCategoryCode(Untdid5305DutyTaxFeeCategories.K));
    ...
    private void populateWithBG21() {
        ...
        charges.getBT0102DocumentLevelChargeVatCategoryCode().add(new BT0102DocumentLevelChargeVatCategoryCode(Untdid5305DutyTaxFeeCategories.K));
    ...
    private void populateBG25WithBG27(BG0025InvoiceLine invoiceLine) {
        ...
        invoiceLineAllowances.getBT0137InvoiceLineAllowanceBaseAmount().add(new BT0137InvoiceLineAllowanceBaseAmount( new BigDecimal("21.0")));
        invoiceLineAllowances.getBT0138InvoiceLineAllowancePercentage().add(new BT0138InvoiceLineAllowancePercentage(new BigDecimal("22.0")));
