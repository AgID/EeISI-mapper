...
public class TypeDescriptor implements Serializable {
    ...
    private TypeDescriptor(@Nullable Class<?> type, @Nullable TypeDescriptor elementTypeDescriptor, @Nullable TypeDescriptor mapKeyTypeDescriptor,
                           @Nullable TypeDescriptor mapValueTypeDescriptor, @Nullable Annotation[] annotations) {
