...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="EN16931-CII" id="EN16931-CII-Syntax">
	...
	<param name="CII-DT-022" value="not(ram:AttachmentBinaryObject) or name()='ram:AdditionalReferencedDocument'"/>
	...
	<param name="CII-DT-058" value="not(ram:DueDateTypeCode)"/>
