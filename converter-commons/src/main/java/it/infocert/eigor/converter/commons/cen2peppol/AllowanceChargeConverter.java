...
public class AllowanceChargeConverter implements CustomMapping<Document> {
    ...
    @Override
    public void map(BG0000Invoice cenInvoice, Document document, List<IConversionIssue> errors, Location callingLocation, EigorConfiguration eigorConfiguration) {
            ...
            for (BG0021DocumentLevelCharges bg0021 : cenInvoice.getBG0021DocumentLevelCharges()) {
                ...
                if (percent == null && base != null) {
                    ...
                    try {
                        ...
                        multiplierFactorNumeric.setText(percentageConverter.convert(percent));
