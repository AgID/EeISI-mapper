...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $BT-29 in (BT-29[starts-with(normalize-space(.), 'IT:EORI:')]) satisfies (($supplierCountry != 'IT') or ((string-length(normalize-space($BT-29)) >= 21) and (string-length(normalize-space($BT-29)) &lt;= 25)))">
          ...
          <svrl:text> [BR-IT-100-1] BT-29 (Seller identifier) - BT-29 minimum length 21 and maximum length shall be 25 starting with "IT:EORI ". 
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="($supplierCountry != 'IT' or matches(normalize-space(.), '(^IT:REA:[A-Z]{2}:[\p{IsBasicLatin}]{1,20}$)'))">
          ...
          <svrl:text> [BR-IT-110] BT-30 (Seller legal registration identifier) - BT-30 minimum length 10 and maximum length shall be 30 starting with "IT:REA:" and  shall be represented as "IT:REA:Ufficio:NumeroREA". 
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="($supplierCountry != 'IT') or matches(normalize-space(.), '^[A-Z0-9]{11,16}$')">
          ...
          <svrl:text> [BR-IT-130] BT-32 (Seller tax registration identifier) - then BT-32 minimum length shall be 11 and maximum length shall be 16. 
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$customerCountry!='IT' or BT-48 or BT-46[starts-with(normalize-space(.),'IT:CF:')]">
          ...
          <svrl:text> [BR-IT-160] BT-46 (Buyer identifier) - BT-46 minimum length 17 and maximum length shall be 22 starting with "IT:CF: ".
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="($customerCountry!='IT') or (string-length(normalize-space(BT-47)) >= 21 and string-length(normalize-space(BT-47)) &lt;=25)">
          ...
          <svrl:text> [BR-IT-170] BT-47 Buyer legal registration identifier. If BT-55 = "IT", if BT-47 starts with "IT:EORI:" then BT-47 minimum length shall be 21 and maximum length shall be 25 
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:template match="BT-49" mode="M3" priority="1027">
    <svrl:fired-rule context="BT-49" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="$customerCountry!='IT' or (          (.[normalize-space(@scheme) = 'IT:CODDEST']          or .[normalize-space(@scheme) = 'IT:PEC']          or .[normalize-space(@scheme) = '0201'] ))" />
      <xsl:otherwise>
        <svrl:failed-assert test="$customerCountry!='IT' or ( (.[normalize-space(@scheme) = 'IT:CODDEST'] or .[normalize-space(@scheme) = 'IT:PEC'] or .[normalize-space(@scheme) = '0201'] ))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="$customerCountry!='IT' or  not(.[normalize-space(@scheme) = '0201'])         or ( matches(normalize-space(.),'^[A-Z0-9]{6}$') )" />
      <xsl:otherwise>
        <svrl:failed-assert test="$customerCountry!='IT' or not(.[normalize-space(@scheme) = '0201']) or ( matches(normalize-space(.),'^[A-Z0-9]{6}$') )">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(normalize-space(.),'^[\-]?[0-9]{1,11}([\.][0-9]{1,8})?$')">
          ...
          <svrl:text>  [BR-IT-290-1]  BT-99 (Document level allowance amount - Document level charge amount) - BT maximum length shall be 21. 
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(normalize-space(.),'^[\-]?[0-9]{1,12}([\.][0-9]{1,8})?$')">
          ...
          <svrl:text> [BR-IT-380] BT-129 (Invoiced quantity) - BT maximum length shall be 21 chars and BT allowed fraction digits shall be 8
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(normalize-space(.), '^[\-]?[0-9]{1,11}([\.][0-9]{1,8})?$')">
          ...
          <svrl:text> [BR-IT-430] BT-146 (Item net price) - BT  maximum length shall be 21. BT allowed fraction digits shall be 8 
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
