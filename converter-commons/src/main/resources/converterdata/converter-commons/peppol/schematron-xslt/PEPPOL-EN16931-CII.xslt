...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocumentContext" mode="M13" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:ApplicableHeaderTradeAgreement" mode="M13" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:ApplicableHeaderTradeSettlement" mode="M13" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument" mode="M13" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:BuyerTradeParty" mode="M13" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SellerTradeParty" mode="M13" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[ram:CalculationPercent and not(ram:BasisAmount)]" mode="M13" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[not(ram:CalculationPercent) and ram:BasisAmount]" mode="M13" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge" mode="M13" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:AppliedTradeAllowanceCharge" mode="M13" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="                 ram:SpecifiedTradeSettlementPaymentMeans[some $code in tokenize('49 59', '\s')                     satisfies normalize-space(ram:TypeCode) = $code]" mode="M13" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:SupplyChainTradeTransaction[ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod/ram:StartDateTime]/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:BillingSpecifiedPeriod/ram:StartDateTime" mode="M13" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:SupplyChainTradeTransaction[ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod/ram:EndDateTime]/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:BillingSpecifiedPeriod/ram:EndDateTime" mode="M13" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:IncludedSupplyChainTradeLineItem" mode="M13" priority="1002">
    ...
    <xsl:variable name="allowancesTotal" select="                     if (ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'false']) then                         xs:decimal(round(sum(ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'false']/ram:ActualAmount) * 10 * 10) div 100)                     else                         0" />
    <xsl:variable name="chargesTotal" select="                     if (ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'true']) then                         xs:decimal(round(sum(ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'true']/ram:ActualAmount) * 10 * 10) div 100)                     else                         0" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:NetPriceProductTradePrice | ram:GrossPriceProductTradePrice" mode="M13" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:NetPriceProductTradePrice/ram:BasisQuantity[@unitCode] | ram:GrossPriceProductTradePrice/ram:BasisQuantity[@unitCode]" mode="M13" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="ram:SellerTradeParty[$supplierCountry = 'NO']" mode="M14" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']" mode="M15" priority="1003">
    <svrl:fired-rule context="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(normalize-space(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ReceivableSpecifiedTradeAccountingAccount/ram:ID/text()) = '')" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(normalize-space(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ReceivableSpecifiedTradeAccountingAccount/ram:ID/text()) = '')">
          <xsl:attribute name="id">DK-R-001</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>For Danish suppliers when the Accounting is known it should be referred on the Invoice</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(((normalize-space(rsm:ExchangedDocument/ram:TypeCode/text())) = '381')       and (number(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/ram:DuePayableAmount/text()) &lt; 0)                         )" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(((normalize-space(rsm:ExchangedDocument/ram:TypeCode/text())) = '381') and (number(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/ram:DuePayableAmount/text()) &lt; 0) )">
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration" mode="M15" priority="1002">
    <svrl:fired-rule context="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem" mode="M15" priority="1001">
    <svrl:fired-rule context="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans" mode="M15" priority="1000">
    <svrl:fired-rule context="rsm:CrossIndustryInvoice[$supplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(($supplierCountry = 'DK')                         and ((ram:TypeCode = '31') or (ram:TypeCode = '42'))                         and not((normalize-space(ram:PayeePartyCreditorFinancialAccount/ram:IBANID/text()) != '') and (normalize-space(ram:PayeeSpecifiedCreditorFinancialInstitution/ram:BICID/text()) != ''))                         )" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(($supplierCountry = 'DK') and ((ram:TypeCode = '31') or (ram:TypeCode = '42')) and not((normalize-space(ram:PayeePartyCreditorFinancialAccount/ram:IBANID/text()) != '') and (normalize-space(ram:PayeeSpecifiedCreditorFinancialInstitution/ram:BICID/text()) != '')) )">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="ram:SellerTradeParty[$supplierCountry = 'IT']/ram:SpecifiedTaxRegistration" mode="M16" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SellerTradeParty[$supplierCountry = 'IT']" mode="M16" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE' and ram:SpecifiedTaxRegistration/substring(ram:ID[@schemeID = 'VAT'], 1, 2) = 'SE']" mode="M17" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedLegalOrganization[../ram:PostalTradeAddress/ram:CountryID = 'SE' and ram:ID]" mode="M17" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE' and ram:SpecifiedLegalOrganization/ram:ID]/ram:SpecifiedTaxRegistration[ram:ID/@schemeID = 'FC']/ram:ID" mode="M17" priority="1004">
    <svrl:fired-rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE' and ram:SpecifiedLegalOrganization/ram:ID]/ram:SpecifiedTaxRegistration[ram:ID/@schemeID = 'FC']/ram:ID" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction[ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE']]/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans[normalize-space(ram:TypeCode) = '30' and normalize-space(ram:PayeeSpecifiedCreditorFinancialInstitution/ram:BICID) = 'SE:BANKGIRO']/ram:PayeePartyCreditorFinancialAccount/ram:ProprietaryID" mode="M17" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction[ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE']]/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans[normalize-space(ram:TypeCode) = '50' or normalize-space(ram:TypeCode) = '56']" mode="M17" priority="1000">
...
<xsl:variable name="ISO3166" select="tokenize('AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL BM BN BO BQ BR BS BT BV BW BY BZ CA CC CD CF CG CH CI CK CL CM CN CO CR CU CV CW CX CY CZ DE DJ DK DM DO DZ EC EE EG EH ER ES ET FI FJ FK FM FO FR GA GB GD GE GF GG GH GI GL GM GN GP GQ GR GS GT GU GW GY HK HM HN HR HT HU ID IE IL IM IN IO IQ IR IS IT JE JM JO JP KE KG KH KI KM KN KP KR KW KY KZ LA LB LC LI LK LR LS LT LU LV LY MA MC MD ME MF MG MH MK ML MM MN MO MP MQ MR MS MT MU MV MW MX MY MZ NA NC NE NF NG NI NL NO NP NR NU NZ OM PA PE PF PG PH PK PL PM PN PR PS PT PW PY QA RE RO RS RU RW SA SB SC SD SE SG SH SI SJ SK SL SM SN SO SR SS ST SV SX SY SZ TC TD TF TG TH TJ TK TL TM TN TO TR TT TV TW TZ UA UG UM US UY UZ VA VC VE VG VI VN VU WF WS YE YT ZA ZM ZW', '\s')" />
  ...
  <xsl:variable name="eaid" select="tokenize('0002 0007 0009 0037 0060 0088 0096 0097 0106 0135 0142 0184 0190 0191 0192 0193 0195 0196 9902 9904 9905 9906 9907 9910 9913 9914 9915 9917 9918 9919 9920 9921 0201 9922 9923 9924 9925 9926 9927 9928 9929 9930 9931 9932 9933 9934 9935 9936 9937 9938 9939 9940 9941 9942 9943 9944 9945 9946 9947 9948 9949 9950 9951 9952 9953 9955 9956 9957 9958', '\s')" />

	<!--RULE -->
<xsl:template match="ram:AttachmentBinaryObject[@mimeCode]" mode="M18" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'false']/ram:ReasonCode" mode="M18" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'true']/ram:ReasonCode" mode="M18" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:CountryID" mode="M18" priority="1004">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="some $code in $ISO3166 satisfies normalize-space(text()) = $code">
	...
	<!--RULE -->
<xsl:template match="ram:TaxTotalAmount[@currencyID]" mode="M18" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:ExchangedDocument/ram:TypeCode" mode="M18" priority="1002">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$profile != '01' or (some $code in tokenize('380 383 386 393 82 80 84 395 575 623 780 381 396 81 83 532', '\s') satisfies normalize-space(text()) = $code)">
	...
	<!--RULE -->
<xsl:template match="udt:DateTimeString" mode="M18" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:BuyerTradeParty/ram:URIUniversalCommunication/ram:URIID | ram:SellerTradeParty/ram:URIUniversalCommunication/ram:URIID" mode="M18" priority="1000">
