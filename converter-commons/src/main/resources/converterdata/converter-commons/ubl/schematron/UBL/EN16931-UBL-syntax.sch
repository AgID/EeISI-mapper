...
<!-- Timestamp: 2016-12-01 22:33:29 +0100 -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="syntax" id="UBL-syntax">
  ...
  <param name="UBL-CR-515" value="not(cac:InvoiceLine/cbc:UUID)"/>
  <param name="UBL-CR-516" value="not(cac:InvoiceLine/cbc:TaxPointDate)"/>
  <param name="UBL-CR-517" value="not(cac:InvoiceLine/cbc:AccountingCostCode)"/>
  <param name="UBL-CR-518" value="not(cac:InvoiceLine/cbc:PaymentPurposeCode)"/>
  <param name="UBL-CR-519" value="not(cac:InvoiceLine/cbc:FreeOfChargeIndicator)"/>
  <param name="UBL-CR-520" value="not(cac:InvoiceLine/cac:InvoicePeriod/cbc:StartTime)"/>
  <param name="UBL-CR-521" value="not(cac:InvoiceLine/cac:InvoicePeriod/cbc:EndTime)"/>
  <param name="UBL-CR-522" value="not(cac:InvoiceLine/cac:InvoicePeriod/cbc:DurationMeasure)"/>
  <param name="UBL-CR-523" value="not(cac:InvoiceLine/cac:InvoicePeriod/cbc:DescriptionCode)"/>
  <param name="UBL-CR-524" value="not(cac:InvoiceLine/cac:InvoicePeriod/cbc:Description)"/>
  <param name="UBL-CR-525" value="not(cac:InvoiceLine/cac:OrderLineReference/cbc:SalesOrderLineID)"/>
  <param name="UBL-CR-526" value="not(cac:InvoiceLine/cac:OrderLineReference/cbc:UUID)"/>
  <param name="UBL-CR-527" value="not(cac:InvoiceLine/cac:OrderLineReference/cbc:LineStatusCode)"/>
  <param name="UBL-CR-528" value="not(cac:InvoiceLine/cac:OrderLineReference/cbc:OrderReference)"/>
  <param name="UBL-CR-529" value="not(cac:InvoiceLine/cac:DespatchLineReference)"/>
  <param name="UBL-CR-530" value="not(cac:InvoiceLine/cac:ReceiptLineReference)"/>
  <param name="UBL-CR-531" value="not(cac:InvoiceLine/cac:BillingReference)"/>
  <param name="UBL-CR-532" value="not(cac:InvoiceLine/cac:DocumentReference/cbc:CopyIndicator)"/>
  ...
  <param name="UBL-CR-540" value="not(cac:InvoiceLine/cac:DocumentReference/cbc:LocaleCode)"/>
  <param name="UBL-CR-541" value="not(cac:InvoiceLine/cac:DocumentReference/cbc:VersionID)"/>
  <param name="UBL-CR-542" value="not(cac:InvoiceLine/cac:DocumentReference/cbc:DocumentStatusCode)"/>
  <param name="UBL-CR-543" value="not(cac:InvoiceLine/cac:DocumentReference/cbc:DocumentDescription)"/>
  <param name="UBL-CR-544" value="not(cac:InvoiceLine/cac:DocumentReference/cac:Attachment)"/>
  <param name="UBL-CR-545" value="not(cac:InvoiceLine/cac:DocumentReference/cac:ValidityPeriod)"/>
  <param name="UBL-CR-546" value="not(cac:InvoiceLine/cac:DocumentReference/cac:IssuerParty)"/>
  <param name="UBL-CR-547" value="not(cac:InvoiceLine/cac:DocumentReference/cac:ResultOfVerification)"/>
  <param name="UBL-CR-548" value="not(cac:InvoiceLine/cac:PricingReference)"/>
  <param name="UBL-CR-549" value="not(cac:InvoiceLine/cac:OriginatorParty)"/>
  <param name="UBL-CR-550" value="not(cac:InvoiceLine/cac:Delivery)"/>
  <param name="UBL-CR-551" value="not(cac:InvoiceLine/cac:PaymentTerms)"/>
  <param name="UBL-CR-552" value="not(cac:InvoiceLine/cac:AllowanceCharge/cbc:ID)"/>
  <param name="UBL-CR-553" value="not(cac:InvoiceLine/cac:AllowanceCharge/cbc:PrepaidIndicator)"/>
  <param name="UBL-CR-554" value="not(cac:InvoiceLine/cac:AllowanceCharge/cbc:SequenceNumeric)"/>
  <param name="UBL-CR-555" value="not(cac:InvoiceLine/cac:AllowanceCharge/cbc:AccountingCostCode)"/>
  <param name="UBL-CR-556" value="not(cac:InvoiceLine/cac:AllowanceCharge/cbc:AccountingCost)"/>
  <param name="UBL-CR-557" value="not(cac:InvoiceLine/cac:AllowanceCharge/cbc:PerUnitAmount)"/>
  <param name="UBL-CR-558" value="not(cac:InvoiceLine/cac:AllowanceCharge/cac:TaxCategory)"/>
  <param name="UBL-CR-559" value="not(cac:InvoiceLine/cac:AllowanceCharge/cac:TaxTotal)"/>
  <param name="UBL-CR-560" value="not(cac:InvoiceLine/cac:AllowanceCharge/cac:PaymentMeans)"/>
  <param name="UBL-CR-561" value="not(cac:InvoiceLine/cac:TaxTotal)"/>
  <param name="UBL-CR-562" value="not(cac:InvoiceLine/cac:WithholdingTaxTotal)"/>
  <param name="UBL-CR-563" value="not(cac:InvoiceLine/cac:Item/cbc:PackQuantity)"/>
  <param name="UBL-CR-564" value="not(cac:InvoiceLine/cac:Item/cbc:PackSizeNumeric)"/>
  <param name="UBL-CR-565" value="not(cac:InvoiceLine/cac:Item/cbc:CatalogueIndicator)"/>
  <param name="UBL-CR-566" value="not(cac:InvoiceLine/cac:Item/cbc:HazardousRiskIndicator)"/>
  <param name="UBL-CR-567" value="not(cac:InvoiceLine/cac:Item/cbc:AdditionalInformation)"/>
  <param name="UBL-CR-568" value="not(cac:InvoiceLine/cac:Item/cbc:Keyword)"/>
  <param name="UBL-CR-569" value="not(cac:InvoiceLine/cac:Item/cbc:BrandName)"/>
  <param name="UBL-CR-570" value="not(cac:InvoiceLine/cac:Item/cbc:ModelName)"/>
  <param name="UBL-CR-571" value="not(cac:InvoiceLine/cac:Item/cac:BuyersItemIdentification/cbc:ExtendedID)"/>
  <param name="UBL-CR-572" value="not(cac:InvoiceLine/cac:Item/cac:BuyersItemIdentification/cbc:BareCodeSymbologyID)"/>
  <param name="UBL-CR-573" value="not(cac:InvoiceLine/cac:Item/cac:BuyersItemIdentification/cac:PhysicalAttribute)"/>
  <param name="UBL-CR-574" value="not(cac:InvoiceLine/cac:Item/cac:BuyersItemIdentification/cac:MeasurementDimension)"/>
  <param name="UBL-CR-575" value="not(cac:InvoiceLine/cac:Item/cac:BuyersItemIdentification/cac:IssuerParty)"/>
  <param name="UBL-CR-576" value="not(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:ExtendedID)"/>
  <param name="UBL-CR-577" value="not(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:BareCodeSymbologyID)"/>
  <param name="UBL-CR-578" value="not(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cac:PhysicalAttribute)"/>
  <param name="UBL-CR-579" value="not(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cac:MeasurementDimension)"/>
  <param name="UBL-CR-580" value="not(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cac:IssuerParty)"/>
  <param name="UBL-CR-581" value="not(cac:InvoiceLine/cac:Item/cac:ManufacturersItemIdentification)"/>
  <param name="UBL-CR-582" value="not(cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cbc:ExtendedID)"/>
  <param name="UBL-CR-583" value="not(cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cbc:BareCodeSymbologyID)"/>
  <param name="UBL-CR-584" value="not(cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cac:PhysicalAttribute)"/>
  <param name="UBL-CR-585" value="not(cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cac:MeasurementDimension)"/>
  <param name="UBL-CR-586" value="not(cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cac:IssuerParty)"/>
  <param name="UBL-CR-587" value="not(cac:InvoiceLine/cac:Item/cac:CatalogueItemIdentification)"/>
  <param name="UBL-CR-588" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemIdentification)"/>
  <param name="UBL-CR-589" value="not(cac:InvoiceLine/cac:Item/cac:CatalogueDocumentReference)"/>
  <param name="UBL-CR-590" value="not(cac:InvoiceLine/cac:Item/cac:ItemSpecificationDocumentReference)"/>
  <param name="UBL-CR-591" value="not(cac:InvoiceLine/cac:Item/cac:OriginCountry/cbc:Name)"/>
  <param name="UBL-CR-592" value="not(cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:NatureCode)"/>
  <param name="UBL-CR-593" value="not(cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:CargoTypeCode)"/>
  <param name="UBL-CR-594" value="not(cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:CommodityCode)"/>
  <param name="UBL-CR-595" value="not(cac:InvoiceLine/cac:Item/cac:TransactionConditions)"/>
  <param name="UBL-CR-596" value="not(cac:InvoiceLine/cac:Item/cac:HazardousItem)"/>
  <param name="UBL-CR-597" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:Name)"/>
  <param name="UBL-CR-598" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:BaseUnitMeasure)"/>
  <param name="UBL-CR-599" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:PerUnitAmount)"/>
  <param name="UBL-CR-600" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:TaxExemptionReasonCode)"/>
  <param name="UBL-CR-601" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:TaxExemptionReason)"/>
  <param name="UBL-CR-602" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:TierRange)"/>
  <param name="UBL-CR-603" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:TierRatePercent)"/>
  <param name="UBL-CR-604" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:Name)"/>
  <param name="UBL-CR-605" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:TaxTypeCode)"/>
  <param name="UBL-CR-606" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:CurrencyCode)"/>
  <param name="UBL-CR-607" value="not(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cac:JurisdiccionRegionAddress)"/>
  <param name="UBL-CR-608" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:ID)"/>
  <param name="UBL-CR-609" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:NameCode)"/>
  <param name="UBL-CR-610" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:TestMethod)"/>
  <param name="UBL-CR-611" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity)"/>
  <param name="UBL-CR-612" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:ValueQualifier)"/>
  <param name="UBL-CR-613" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:ImportanceCode)"/>
  <param name="UBL-CR-614" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:ListValue)"/>
  <param name="UBL-CR-615" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cac:UsabilityPeriod)"/>
  <param name="UBL-CR-616" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cac:ItemPropertyGroup)"/>
  <param name="UBL-CR-617" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cac:RangeDimension)"/>
  <param name="UBL-CR-618" value="not(cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cac:ItemPropertyRange)"/>
  <param name="UBL-CR-619" value="not(cac:InvoiceLine/cac:Item/cac:ManufacturerParty)"/>
  <param name="UBL-CR-620" value="not(cac:InvoiceLine/cac:Item/cac:InformationContentProviderParty)"/>
  <param name="UBL-CR-621" value="not(cac:InvoiceLine/cac:Item/cac:OriginAddress)"/>
  <param name="UBL-CR-622" value="not(cac:InvoiceLine/cac:Item/cac:ItemInstance)"/>
  <param name="UBL-CR-623" value="not(cac:InvoiceLine/cac:Item/cac:Certificate)"/>
  <param name="UBL-CR-624" value="not(cac:InvoiceLine/cac:Item/cac:Dimension)"/>
  <param name="UBL-CR-625" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:PriceChangeReason)"/>
  <param name="UBL-CR-626" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:PriceTypeCode)"/>
  <param name="UBL-CR-627" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:PriceType)"/>
  <param name="UBL-CR-628" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:OrderableUnitFactorRate)"/>
  <param name="UBL-CR-629" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:ValidityPeriod)"/>
  <param name="UBL-CR-630" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:PriceList)"/>
  <param name="UBL-CR-631" value="not(cac:InvoiceLine/cac:Item/cac:Price/cbc:OrderableUnitFactorRate)"/>
  <param name="UBL-CR-632" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:ID)"/>
  <param name="UBL-CR-633" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode)"/>
  <param name="UBL-CR-634" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:AllowanceChargeReason)"/>
  <param name="UBL-CR-635" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:MultiplierFactorNumeric)"/>
  <param name="UBL-CR-636" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:PrepaidIndicator)"/>
  <param name="UBL-CR-637" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:SequenceNumeric)"/>
  <param name="UBL-CR-638" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:AccountingCostCode)"/>
  <param name="UBL-CR-639" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:AccountingCost)"/>
  <param name="UBL-CR-640" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cbc:PerUnitAmount)"/>
  <param name="UBL-CR-641" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cac:TaxCategory)"/>
  <param name="UBL-CR-642" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cac:TaxTotal)"/>
  <param name="UBL-CR-643" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:AllowanceCharge/cac:PaymentMeans)"/>
  <param name="UBL-CR-644" value="not(cac:InvoiceLine/cac:Item/cac:Price/cac:PricingExchangeRate)"/>
