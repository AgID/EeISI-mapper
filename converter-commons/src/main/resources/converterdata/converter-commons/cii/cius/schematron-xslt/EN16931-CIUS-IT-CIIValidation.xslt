...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EN16931 CII CIUS">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EN16931 CII CIUS</svrl:text>

<!--PATTERN CIUS-IT-->


	<!--RULE -->
<xsl:template match="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:PayeePartyCreditorFinancialAccount" mode="M7" priority="1000">
    <svrl:fired-rule context="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:PayeePartyCreditorFinancialAccount" />
