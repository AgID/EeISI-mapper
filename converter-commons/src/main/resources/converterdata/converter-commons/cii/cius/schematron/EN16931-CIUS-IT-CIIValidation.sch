...
1. updated the rules BR-IT-190 and BR-IT-200 as there will only be schemeID 0201 corresponding to 0201
   0201, IT:PEC, IT:CODDEST will be registered under ISO 6523 as requested by CEF in mid december 2018 (no changes to these rules)
   Rules impacted BR-IT-190 - BR-IT-200-2

2. Added NEW rules  
   BR-IT-295 (new context: <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement">
   BR-IT-435 
   BR-IT-480 same context of BR-IT-435
   BR-IT-490 (new context:   <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction">

FIX:
  BR-IT-150 => wrong reference to customerCountry instead supplierCountry
  
   Change Log 2019-03-13
  1. Added license comment
  according to latest Ade CIUS table (25/02/2019)
  2. BR-IT-350 deleted L, M
  3. BR-IT-295 commented 
  4. BR-IT-435 commented 
  5. BR-IT-480 commented
  6. BR-IT-490 commented
  
  Change Log 2019-03-27
   1. BR-IT-380 negative values are admitted and then transformed by the mapper 
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <title>Italian Rules for EN16931 model in CII Syntax</title>
  
  <!-- Parameters         
    NOTE: using upper-case function it=IT uk=UK 
    We have to pay attention in the mapping to XML-PA to convert in uppercase, too.
  --> 
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"  id="CIUS-IT">
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument">
    ...
    EeISI Rule 
     ...
     (ENG): BT maximum length shall be 20 digit
    ...
    Error Message: BT maximum length shall be 20 chars with at least a digit.
    -->    
    <assert test=  "string-length(normalize-space(ram:ID)) &lt;= 20 and matches(normalize-space(ram:ID),'(^\p{IsBasicLatin}*[0-9]+\p{IsBasicLatin}*$)')" 
      id="BR-IT-010" 
    ...
    <assert test=  " 
      count(distinct-values(//ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:ALIQUOTA']/ram:Value))&lt;= 1 
      and 
      count(distinct-values(//ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:TIPO']/ram:Value))&lt;= 1
      and
      count(distinct-values(//ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:CAUSALE']/ram:Value))&lt;= 1
      "
      id="BR-IT-490" 
  ...
  -->
   ...
   <!--  
    ...
    <assert test="( count(ram:SpecifiedTradeAllowanceCharge[ram:ChargeIndicator/udt:Indicator='true'][normalize-space(ram:Reason)='IT:BOLLO']) &lt;= 1 )"
      id="BR-IT-295" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ReceivableSpecifiedTradeAccountingAccount">
    ...
    EeISI Rule 
     (ITA): La lunghezza dell'elemento non può superare i 20 caratteri   
     (ENG): BT maximum length shall be 20 chars
    ...
    --> 
    <assert test=  "matches(normalize-space(ram:ID),'^\p{IsBasicLatin}{0,20}$')" 
      id="BR-IT-080" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:URIUniversalCommunication">
    ...
    eEISI CIUS Reference: BR-IT-190
     ...
     (ITA): L'elemento BT-49 Buyer electronic address deve contenere la PEC del destinatario della fattura, 
            ...
            Di conseguenza per l'elemento BT-49-1 Buyer electronic address identification scheme identifier sono previsti i valori IT:PEC, 0201 (0201) oppure IT:CODDEST
   ...
   -->
    ...
    <assert test=  "exists(ram:URIID) 
      and (ram:URIID[normalize-space(@schemeID) = 'IT:CODDEST'] or ram:URIID[normalize-space(@schemeID) = 'IT:PEC'] or ram:URIID[normalize-space(@schemeID) = '0201'] )"
      id="BR-IT-190" 
    ...
    eEISI CIUS Referemce: BR-IT-200-1, BR-IT-200-2, BR-IT-200-3
     ...
     (ITA): Se il valore dell’elemento BT-55 Buyer country code è ”IT”, 
            ...
            Altrimenti, se l'elemento BT-49-1 Buyer electronic address identification scheme identifier contiene il valore "0201" (0201),
    ...
    <assert test=  "$customerCountry!='IT' or not(ram:URIID[normalize-space(@schemeID) = 'IT:PEC']) 
      or ( (string-length(normalize-space(ram:URIID)) &gt;= 7 and string-length(normalize-space(ram:URIID)) &lt;= 256) and matches(normalize-space(ram:URIID),'^.+@.+[.]+.+$') )" 
      id="BR-IT-200-1" 
    ...
    <assert test=  "$customerCountry!='IT' or not(ram:URIID[normalize-space(@schemeID) = '0201'] ) or (matches(normalize-space(ram:URIID),'^[A-Z0-9]{6}$'))"
      id="BR-IT-200-2" 
    ...
    <assert test=  "$customerCountry!='IT' or not(ram:URIID[normalize-space(@schemeID)] = 'IT:CODDEST') or (matches(normalize-space(ram:URIID),'^[A-Z0-9]{7}$'))" 
      id="BR-IT-200-3" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty">
    ...
    EeISI Rule
      ...
      ENG: If BT-55 = "IT", 
            ...
            BT-46 shall starts with "IT:CF" and minimum length shall be 17 and maximum length shall be 22
    ...
    Error Message: 1.4.1.1 is not mandatory in XMLPA (buyer) but VAT number or Fiscal code should be indicated as IT:CF in BT-46 when BT-55="IT"     
    -->     
    <assert test=  "$customerCountry!='IT' or ram:SpecifiedTaxRegistration/ram:ID[normalize-space(@schemeID)='VA'] 
      or ram:GlobalID[starts-with(normalize-space(.),'IT:CF:')] or ram:ID[starts-with(normalize-space(.),'IT:CF:')]" 
      id="BR-IT-160" 
      flag="fatal"> [BR-IT-160] BT-48 BT-46, BT-46-1 (Buyer VAT identifier - Buyer identifier - Buyer identifier identification scheme identifier) - f BT-48 is empty then BT-46 should be the FiscalCode. BT-46 shall starts with "IT:CF". 
    </assert>
  ...
  EeISI Rule
   ...
   Error Message: BT46-1=IT:CF then BT-46 should a CodiceFiscale and minimum length shal be 11 and maximum length shall be 16 
   -->      
    
    <assert test=  "$customerCountry != 'IT' or not(ram:GlobalID[starts-with(normalize-space(.),'IT:CF')])
      or ( matches(normalize-space(ram:GlobalID[starts-with(normalize-space(.),'IT:CF')]),'(^IT:CF:[A-Z0-9]{11,16}$)'))" 
      id="BR-IT-160-1"
      flag="warning"> [BR-IT-160] BT-46 (Buyer identifier) - BT-46 minimum length 17 and maximum length shall be 22 starting with "IT:CF: ". 
    </assert>
    <assert test=  "$customerCountry != 'IT' or not(ram:ID[starts-with(normalize-space(.),'IT:CF')]) 
      or ( matches(normalize-space(ram:ID[starts-with(normalize-space(.),'IT:CF')]),'(^IT:CF:[A-Z0-9]{11,16}$)'))" 
      id="BR-IT-160-2"
      flag="warning"> [BR-IT-160] BT-46 (Buyer identifier) - BT-46 minimum length 17 and maximum length shall be 22 starting with "IT:CF: ". 
    </assert> 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedLegalOrganization">
    ...
    eEISI CIUS Reference: BR-IT-170
     ...
     (ENG): If BT-55 = "IT", if BT-47 starts with "IT:EORI:" then BT-47 minimum length shall be 21 and maximum length shall be 25
    ...
    Error Message:
    -->
    <assert test=  "$customerCountry != 'IT' or not(ram:ID[starts-with(normalize-space(.),'IT:EORI:')])
      or (string-length(normalize-space(ram:ID)) &gt;= 21 and string-length(normalize-space(ram:ID)) &lt;=25)" 
 
      id="BR-IT-170" 
      flag="fatal"> [BR-IT-170] BT-47 Buyer legal registration identifier. If BT-55 = "IT", if BT-47 starts with "IT:EORI:" then BT-47 minimum length shall be 21 and maximum length shall be 25 
    </assert> 
  </rule>
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedTaxRegistration">
    ...
    EeISI Rule 
     ...
     (ENG): BT maximum length shall be 30 chars
    ...
    Error Message:
    -->     
    <assert test=  "not (ram:ID[normalize-space(@schemeID)='VA']) or (string-length(normalize-space(ram:ID[normalize-space(@schemeID)='VA'])) &lt;= 30 ) " 
      id="BR-IT-180" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress">
    ...
    -->   
    <assert test=  "not($customerCountry = 'IT') or ram:LineOne" 
      id="BR-IT-210-1" 
      flag="fatal"> [BR-IT-210-1] BT-50 (Buyer address line 1) - Fields are mandatory in Italy. 
    </assert>
    <assert test=  "not($customerCountry = 'IT') or ram:CityName" 
      id="BR-IT-210-2" 
      flag="fatal"> [BR-IT-210-2] BT-52 (Buyer city) - Fields are mandatory in Italy. 
    </assert>
    <assert test=  "not($customerCountry = 'IT') or matches(normalize-space(ram:PostcodeCode),'^[0-9]{5}$')" 
      id="BR-IT-210-3" 
    ...
    Error Message:
    --> 
    <assert test=  "not($customerCountry = 'IT') or not(ram:CountrySubDivisionName) or matches(normalize-space(ram:CountrySubDivisionName),'^[A-Z]{2}$')" 
      id="BR-IT-220" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty">
    ...
    Using schema identifer BT-29-1 (CURRENTLY NOT AVAILABLE)
      BT-29-1=IT:EORI then BT-29 minimum length 13 and maximum length shall be 17 
      BT-29-1=IT:ALBO then BT-29 maximum length shall be 121 (AlboProfessionale:NumeroIscrizioneAlbo)

    Temporary rules (PRODUCTION)
      If BT-29 starts with IT:EORI then BT-29 minimum length 21 and maximum length shall be 25 (IT:EORI:CodiceEORI)
      (ADDED) If BT-29 starts with IT:ALBO then BT-29 maximum length shall be 128 (IT:ALBO:AlboProfessionale:NumeroIscrizioneAlbo)
     ...
     It is  required to test multiple instances
      ...
      -->
    <!-- EORI -->
    <assert test=  "every $GlobalID in (ram:GlobalID[starts-with(normalize-space(.),'IT:EORI:')]) satisfies (($supplierCountry!='IT')  
      or ( (string-length(normalize-space($GlobalID)) &gt;= 21) and (string-length(normalize-space($GlobalID)) &lt;=25)))" 
      id="BR-IT-100-1A" 
      flag="fatal"> [BR-IT-100-1] BT-29 (Seller identifier) - BT-29 minimum length 21 and maximum length shall be 25 starting with "IT:EORI ". 
    </assert>
    
    <assert test=  "every $ramID in (ram:ID[starts-with(normalize-space(.),'IT:EORI:')]) satisfies (($supplierCountry!='IT') 
      or ( (string-length(normalize-space($ramID)) &gt;= 21) and (string-length(normalize-space($ramID)) &lt;=25)))" 
      id="BR-IT-100-1B" 
      flag="fatal"> [BR-IT-100-1] BT-29 (Seller identifier) - BT-29 minimum length 21 and maximum length shall be 25 starting with "IT:EORI ". 
    </assert>
    
    <!-- ALBO -->  
    <assert test=  "every $GlobalID in (ram:GlobalID[starts-with(normalize-space(.),'IT:ALBO:')]) 
      satisfies (($supplierCountry!='IT') or (matches(normalize-space($GlobalID), '(^IT:ALBO:[\p{IsBasicLatin} -[:]]{1,60}:[\p{IsBasicLatin}\p{IsLatin-1Supplement} -[:]]{1,60}$)')))" 
      id="BR-IT-100-2A" 
    ...
    <assert test=  "every $ramID in (ram:ID[starts-with(normalize-space(.),'IT:ALBO:')]) 
      satisfies (($supplierCountry!='IT') or (matches(normalize-space($ramID), '(^IT:ALBO:[\p{IsBasicLatin} -[:]]{1,60}:[\p{IsBasicLatin}\p{IsLatin-1Supplement} -[:]]{1,60}$)')))" 
      id="BR-IT-100-2B" 
      flag="fatal"> [BR-IT-100-2] BT-29 (Seller identifier) - BT-29 starting with "IT:ALBO has the format IT:ALBO:AlboProfessionale(1-60chars):NumeroIscrizioneAlbo(1-60chars) - (:) colon is permitted only as separator". 
    </assert>
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedLegalOrganization">
    ...
    EeISI Rule
      ...
      ENG:
        ...
        then BT-30 minimum length shall be 10 and maximum length shall be 29 (first two chars indicate the italian province code)
    ...
    Restriction:
    BT-30-1=IT:REA then BT-30 minimum length 3 and maximum length shall be 22 (first two chars indicate the italian province code)
    ...
    -->        
    <assert 
      test="every $ramID in (ram:ID[starts-with(normalize-space(.), 'IT:REA:')])
      satisfies ($supplierCountry != 'IT' or matches(normalize-space($ramID), '(^IT:REA:[A-Z]{2}:[\p{IsBasicLatin}]{1,20}$)'))"
      id="BR-IT-110" 
      flag="fatal"> [BR-IT-110] BT-30 (Seller legal registration identifier) - BT-30 minimum length 10 and maximum length shall be 30 starting with "IT:REA:" and shall be represented as "IT:REA:Ufficio:NumeroREA". 
    </assert>
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration">
    <!--  
      ...
      EeISI Rule (ITA):
        ...
        (ENG): If BT-40 = "IT", then BT-32 minimum length shall be 17 and maximum length shall be 22 
        => FATAL
  ...
  -->
    <assert 
      test=  "$supplierCountry!='IT' or ram:ID[normalize-space(@schemeID) !='FC'] or matches(normalize-space(ram:ID[normalize-space(@schemeID) ='FC']) ,'^[A-Z0-9]{11,16}$')"      
      id="BR-IT-130" 
      flag="fatal"> [BR-IT-130] BT-32 (Seller tax registration identifier) - then BT-32 minimum length shall be 11 and maximum length shall be 16. 
    </assert>
    ...
    Error Message:
    -->    
    <assert test=  "$supplierCountry!='IT' or not (ram:ID[normalize-space(@schemeID) = 'VA']) or string-length(normalize-space(ram:ID[normalize-space(@schemeID) ='VA'])) &lt;= 30" 
      id="BR-IT-120" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress">
    ...
    Error Message:
    --> 
    <assert test=  "not($supplierCountry = 'IT') or not(ram:CountrySubDivisionName) or matches(normalize-space(ram:CountrySubDivisionName),'^[A-Z]{2}$')" 
      id="BR-IT-150" 
    ...
    Error Message:
    -->
    <assert test=  "not($supplierCountry = 'IT') or ram:LineOne" 
      id="BR-IT-140-1" 
      flag="fatal"> [BR-IT-140-1] BT-35 (Seller address line 1) - Fields are mandatory in Italy.
    </assert>
    <assert test=  "not($supplierCountry = 'IT') or ram:CityName" 
      id="BR-IT-140-2" 
      flag="fatal"> [BR-IT-140-2] BT-37 (Seller city) - Fields are mandatory in Italy. 
    </assert>
    <assert test=  "not($supplierCountry = 'IT') or matches(normalize-space(ram:PostcodeCode),'^[0-9]{5}$')" 
      id="BR-IT-140-3" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:TypeCode ='916']">
    ...
    Error Message:
    --> 
    <assert test=  "ram:URIID or ram:AttachmentBinaryObject" 
      id="BR-IT-360" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge">
    ...
    EeISI Rule 
     ...
     (ENG): BT minimum length shall be 4 maximum length shall be 15 chars
    ...
    Error Message:
    -->
    <assert test=  "matches(normalize-space(ram:ActualAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?$')" 
      id="BR-IT-290" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge">
    ...
    EeISI Rule 
     ...
     (ENG): BT minimum length shall be 4 maximum length shall be 21 chars
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument">
    ...
    Error Message:
    -->
    <assert test=  "matches(normalize-space(ram:IssuerAssignedID),'^\p{IsBasicLatin}{1,20}$')" 
      id="BR-IT-090" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax">
    ...
    EeISI Rule 
     ...
     (ENG): minimum length shall be 4 maximum length shall be 15 chars
    ...
    Error Message:
    -->
    <assert test=  "matches(normalize-space(ram:BasisAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?')" 
      id="BR-IT-330" 
    ...
    Imposta (XML-PA) pattern: [\-]?[0-9]{1,11}\.[0-9]{2}  
  	NB la lunghezza minima è garantita dal mapper che aggiunge .00 nel caso non siano presenti decimali
    -->
    <assert test=  "matches(normalize-space(ram:CalculatedAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?$')" 
      id="BR-IT-340" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument">
    ...
    EeISI Rule 
     ...
     (ENG): BT maximum length shall be 15 chars
    ...
    Error Message:
    -->
    <assert test=  "not(normalize-space(ram:TypeCode) = '50') or (matches(normalize-space(ram:IssuerAssignedID),'^\p{IsBasicLatin}{1,15}$') and ram:TypeCode = '50')" 
      id="BR-IT-070" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerOrderReferencedDocument">
    ...
    Error Message:
    --> 
    <assert test=  "matches(normalize-space(ram:IssuerAssignedID),'^\p{IsBasicLatin}{0,20}$')" 
      id="BR-IT-040" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:PostalTradeAddress">
    ...
    Error Message:
    -->
    <assert test=  "not(ram:CountryID = 'IT') or not(ram:CountrySubDivisionName) or matches(normalize-space(ram:CountrySubDivisionName),'^[A-Z]{2}$') " 
      id="BR-IT-250" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTaxRepresentativeTradeParty/ram:SpecifiedTaxRegistration">
    ...
    Error Message:
    -->
    <assert test=  "string-length(normalize-space(ram:ID[normalize-space(@schemeID)='VA'])) &lt;= 30"         
      id="BR-IT-230" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SpecifiedProcuringProject">
    ...
    Error Message:
    --> 
    <assert test=  " matches(normalize-space(ram:ID),'^\p{IsBasicLatin}{0,15}$') and ram:Name = 'Project reference'"
      id="BR-IT-020" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation">
    ...
    Error Message:
    -->
    <assert test=  "matches(normalize-space(ram:GrandTotalAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?$')" 
      id="BR-IT-300" 
    ...
    Restriction: BT minimum length shall be 4 maximum length shall be 15 chars   
	NB la lunghezza minima è garantita dal mapper che aggiunge .00 nel caso non siano presenti decimali
    -->
    <assert test=  "not(exists(ram:RoundingAmount)) or (matches(normalize-space(ram:RoundingAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?$'))" 
      id="BR-IT-310" 
	...
	NB la lunghezza minima è garantita dal mapper che aggiunge .00 nel caso non siano presenti decimali
    -->
    <assert test=  "matches(normalize-space(ram:DuePayableAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?$')" 
      id="BR-IT-320" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:PayeePartyCreditorFinancialAccount">
    ...
    Error Message:
    -->
    <assert test=  "matches(normalize-space(ram:IBANID), '(^[a-zA-Z]{2}[0-9]{2}[a-zA-Z0-9]{11,30})$')" 
      id="BR-IT-270" 
  ...
  EeISI Rule 
   ...
   (ENG): BT minimum length shall be 8 maximum length shall be 11 chars (BIC)
    ...
    Error Message:
    -->
    <assert test=  "not(ram:BICID) or matches(normalize-space(ram:BICID),'^[A-Z]{6}[A-Z2-9][A-NP-Z0-9]([A-Z0-9]{3}){0,1}$')" 
      id="BR-IT-280" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:AdditionalReferencedDocument">
    ...
    eEISI CIUS Referemce: BR-IT-370
     ...
     (ENG): BT maximum length shall be 35 chars
    ...
    Error Message:
    -->
    <assert test=  "not(ram:IssuerAssignedID) or (matches(normalize-space(ram:IssuerAssignedID), '^\p{IsBasicLatin}{1,35}$') and ram:TypeCode='130')" 
      id="BR-IT-370" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement">
    ...
    EeISI Rule 
     ...
     (ENG): BT minimum length shall be 4 maximum length shall be 21 chars. BT allowed fraction digits shall be 8
    ...
    Error Message:
    -->
    <assert test=  "matches(normalize-space(ram:NetPriceProductTradePrice/ram:ChargeAmount), '^[\-]?[0-9]{1,11}([\.][0-9]{1,8})?$')"        
      id="BR-IT-430" 
      flag="fatal"> [BR-IT-430] BT-146 (Item net price) - BT  maximum length shall be 21. BT allowed fraction digits shall be 8 
    </assert>
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeDelivery">
    ...
    EeISI Rule 
     (ITA): La lunghezza dell'elemento deve essere compresa fra 4 e 21 caratteri e l'elemento dovrà avere 8 cifre decimali 
     (ENG): BT minimum length shall be 4 maximum length shall be 21 chars and BT allowed fraction digits shall be 8
    ...
    Quantita (XML-PA)pattern: [0-9]{1,12}\.[0-9]{2,8}
	  NB la lunghezza minima è garantita dal mapper che aggiunge .00 nel caso non siano presenti decimali
     As in CEN the value can be negative it is admitted a minus but then the mapper transfers the minus to prezzoUnitario
    
    Error Message:
    -->    
    
    <assert test=  "matches(normalize-space(ram:BilledQuantity),'^[\-]?[0-9]{1,12}([\.][0-9]{1,8})?$')" 
      id="BR-IT-380" 
      flag="fatal"> [BR-IT-380] BT-129 (Invoiced quantity) - BT maximum length shall be 21 chars and BT allowed fraction digits shall be 8
    </assert>
  </rule>
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation">
    ...
    Restriction: BT minimum length shall be 4 maximum length shall be 21 chars  
	  NB la lunghezza minima è garantita dal mapper che aggiunge .00 nel caso non siano presenti decimali	

    Error Message:  
    -->
    <assert test=  "matches(normalize-space(ram:LineTotalAmount),'^[\-]?[0-9]{1,11}([\.][0-9]{1,2})?$')" 
      id="BR-IT-390" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedTradeProduct">
    ...
    --> 
		<!--
    <assert test=  "normalize-space(ram:Name) = 'IT:CASSA' and 
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:CASSA:TIPO'])=1 and 
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:CASSA:ALIQUOTA'])=1 
      or
      not(normalize-space(ram:Name) = 'IT:CASSA')      
      "
      id="BR-IT-435" 
...
-->
	...
	<!--
    <assert test=  " 
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:ALIQUOTA'])=1 and 
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:TIPO'])=1 and
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:CAUSALE'])=1
      or
      (
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:ALIQUOTA'])=0 and 
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:TIPO'])=0 and
      count(ram:ApplicableProductCharacteristic[normalize-space(ram:Description) ='IT:RITENUTA:CAUSALE'])=0
      )"
      id="BR-IT-480" 
      flag="fatal"> [BR-IT-480] BT-160 - Item attribute name - if BT-160="IT:RITENUTA:ALIQUOTA" or BT-160="IT:RITENUTA:TIPO" or BT-160="IT:RITENUTA:CAUSALE", then three instances of BG-32 shall have BT-160="IT:RITENUTA:ALIQUOTA", BT-160="IT:RITENUTA:TIPO" and BT-160="IT:RITENUTA:CAUSALE". 
    </assert>
-->
    <!--  
    ID: BT-155
    ...
    Error Message:
    --> 
    <assert test=  "matches(normalize-space(ram:SellerAssignedID),'^\p{IsBasicLatin}{0,35}$')"
      id="BR-IT-440" 
    ...
    Error Message:
    -->     
    <assert test=  "matches(normalize-space(ram:BuyerAssignedID),'^\p{IsBasicLatin}{0,35}$')"
      id="BR-IT-450" 
    ...
    Error Message:
    --> 
    <assert test=  "matches(normalize-space(ram:GlobalID),'^\p{IsBasicLatin}{0,35}$')"
      id="BR-IT-460" 
  ...
  <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedTradeProduct/ram:DesignatedProductClassification">
    ...
    Error Message:
    --> 
    <assert test=  "matches(normalize-space(ram:ClassCode),'^\p{IsBasicLatin}{0,35}$')"
      id="BR-IT-470" 
  ...
  <rule context="ram:CategoryCode">
    <!--  
      ...
      eEISI CIUS Referemce: BR-IT-350
       ...
       EeISI Rule 
       (ITA): I valori accettati sono esclusivamente AE E S G  K 
       (ENG): for BT-118 only values AE E S G  K shall be allowed
    ...
    Error Message:
    -->  
    <assert test="( ( not(contains(normalize-space(.),' ')) and contains( ' AE E S G K ',concat(' ',normalize-space(.),' ') ) ) )"
      id="BR-IT-350" 
      flag="fatal"> [BR-IT-350] VAT category codes - only values E (Exempt from VAT), K	(Intra-community supply), AE (Reverse charge), G (Export outside the EU) ,S (Standard rated) shall be allowed . 
    </assert>
  </rule>
