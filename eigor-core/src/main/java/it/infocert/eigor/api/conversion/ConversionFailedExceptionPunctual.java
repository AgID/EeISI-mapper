...
public class ConversionFailedExceptionPunctual extends ConversionFailedException {

    private final Class sourceType;
    private final Class destinationType;
    private final Object offendingValue;

    public ConversionFailedExceptionPunctual(Class sourceType, Class destinationType, Object offendingValue) {
        super();
