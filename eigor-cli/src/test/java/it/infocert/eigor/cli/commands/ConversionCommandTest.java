...
//    String sourceFormat = "xmlcen";
//    String targetFormat = "xmlcen";
//    @Mock
...
//    private InputStream invoiceSourceFormat;
//
//    @Before
...
//
//    @Before
//    public void setUpInitFolder() throws IOException {
...
//                .setInputInvoice(inputInvoice).setOutputFolder(outputFolder).setInvoiceInSourceFormat(invoiceInSourceFormat).setForceConversion(false).setConfiguration(configuration).setRunIntermediateValidation(false).build();
//
