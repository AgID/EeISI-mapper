...
public class Cen2Ubl extends AbstractFromCenConverter {
    ...
    public void configure() throws ConfigurationException {
        ...
        {
            try {
                xsdValidator = new ClasspathXSDValidator("/converterdata/converter-commons/ubl/xsdstatic/UBL-Invoice-2.1.xsd", ErrorCode.Location.UBL_OUT);
            } catch (Exception e) {
        ...
        try {
            ...
            ublValidator = new SchematronValidator(new FileSystemResource(ublSchemaFile.getFile()), true, schematronAutoUpdate, ErrorCode.Location.UBL_OUT);
        } catch (Exception e) {
