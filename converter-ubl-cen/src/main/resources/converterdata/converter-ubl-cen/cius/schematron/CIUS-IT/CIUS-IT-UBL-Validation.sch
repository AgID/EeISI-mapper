<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="syntax" id="CIUS-IT">
    ...
    <param name="CIUS-BT-98"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:CompanyID)"/>
    ...
    <param name="CIUS-CA-9-1"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID)"/>
    <param name="CIUS-CA-9-2"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cac:TaxRepresentativeParty/cac:PartyTaxScheme/cbc:CompanyID)"/>
    <param name="CIUS-CA-10_CONTEXT" value="cac:AccountingSupplierParty/cac:Party/cac:PostalAddress"/>
    <param name="CIUS-CA-10-1"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:StreetName)"/>
    <param name="CIUS-CA-10-2"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:CityName)"/>
    <param name="CIUS-CA-10-3"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:PostalZone)"/>
    <param name="CIUS-CA-11_CONTEXT" value="cac:AccountingCustomerParty/cac:Party/cac:PostalAddress"/>
    <param name="CIUS-CA-11-1"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:StreetName)"/>
    <param name="CIUS-CA-11-2"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:CityName)"/>
    <param name="CIUS-CA-11-3"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or exists(cbc:PostalZone)"/>
    <param name="CIUS-CA-12_CONTEXT" value="cac:Delivery/cac:DeliveryLocation/cac:Address"/>
    <param name="CIUS-CA-12-1"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or (not(exists(//ubl:Invoice/cac:ReceiptDocumentReference/cbc:ID)) or exists(cbc:StreetName))"/>
    <param name="CIUS-CA-12-2"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or (not(exists(//ubl:Invoice/cac:ReceiptDocumentReference/cbc:ID)) or exists(cbc:CityName))"/>
    <param name="CIUS-CA-12-3"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or (not(exists(//ubl:Invoice/cac:ReceiptDocumentReference/cbc:ID)) or exists(cbc:PostalZone))"/>
    <param name="CIUS-CA-71_CONTEXT" value="//ubl:Invoice"/>
    <param name="CIUS-CA-71"
           value="exists(cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI) or exists(cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject)"/>
    ...
    <param name="CIUS-CI-13"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or matches(cbc:TaxCurrencyCode, 'EUR')"/>
    <param name="CIUS-BR-14_CONTEXT" value="//ubl:Invoice/cac:AccountingCustomerParty/cac:Party"/>
    <param name="CIUS-BR-14"
           value="exists(cac:PartyTaxScheme/cbc:CompanyID) or ( exists(cac:PartyIdentification/cbc:ID) and exists(cac:PartyIdentification/cbc:ID/@schemeID) )"/>
    ...
    <param name="CIUS-VD-20"
           value="(string-length(cbc:StreetName) + string-length(cbc:AdditionalStreetName) + string-length(cac:AddressLine/cbc:Line)) &lt;= 180"/>
    <param name="CIUS-VD-21_CONTEXT" value="cac:AccountingCustomerParty/cac:Party/cac:PostalAddress"/>
    <param name="CIUS-VD-21"
           value="(string-length(cbc:StreetName) + string-length(cbc:AdditionalStreetName) + string-length(cac:AddressLine/cbc:Line)) &lt;= 180"/>
    <param name="CIUS-VD-22_CONTEXT" value="cac:Delivery/cac:DeliveryLocation/cac:Address"/>
    <param name="CIUS-VD-22"
           value="(string-length(cbc:StreetName) + string-length(cbc:AdditionalStreetName) + string-length(cac:AddressLine/cbc:Line)) &lt;= 180"/>
    ...
    <param name="CIUS-VD-26-2"
           value="not(cac:Country/cbc:IdentificationCode = 'IT') or ( string-length(cbc:PostalZone) &lt;= 5 and number(cbc:PostalZone) &gt; 0 )"/>
    ...
    <param name="CIUS-VD-45"
           value="string-length(cbc:Telephone) &lt;= 12 and string-length(cbc:Telephone) &gt;= 5"/>
    <param name="CIUS-VD-46_CONTEXT" value="cac:AccountingSupplierParty/cac:Party/cac:Contact"/>
    <param name="CIUS-VD-46"
           value="string-length(cbc:ElectronicMail) &lt;= 256 and string-length(cbc:ElectronicMail) &gt;= 7"/>
    <param name="CIUS-VD-47_CONTEXT" value="cac:AccountingSupplierParty/cac:Party/cac:PostalAddress"/>
    <param name="CIUS-VD-47"
    ...
    <param name="CIUS-VD-59_CONTEXT"
           value="cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch"/>
    ...
    <param name="CIUS-VD-60"
           value="(string-length(cbc:AllowanceChargeReason) + string-length(cbc:AllowanceChargeReasonCode)) &lt;= 1000"/>
    <param name="CIUS-VD-61_CONTEXT" value="cac:AllowanceCharge"/>
    <param name="CIUS-VD-61"
           value="(string-length(cbc:AllowanceChargeReason) + string-length(cbc:AllowanceChargeReasonCode)) &lt;= 1000"/>
    <param name="CIUS-VD-62_CONTEXT" value="cac:LegalMonetaryTotal"/>
    <param name="CIUS-VD-62"
           value="string-length(cbc:TaxInclusiveAmount) &lt;= 15 and string-length(cbc:TaxInclusiveAmount) &gt;= 4"/>
    <param name="CIUS-VD-63_CONTEXT" value="cac:LegalMonetaryTotal"/>
    <param name="CIUS-VD-63"
           value="string-length(cbc:PayableAmount) &lt;= 15 and string-length(cbc:PayableAmount) &gt;= 4"/>
    ...
    <param name="CIUS-VD-65"
           value="not(exists(cbc:PayableRoundingAmount)) or (string-length(cbc:PayableRoundingAmount) &lt;= 15 and string-length(cbc:PayableRoundingAmount) &gt;= 4)"/>
    <param name="CIUS-VD-66_CONTEXT" value="cac:TaxTotal/cac:TaxSubtotal"/>
    <param name="CIUS-VD-66"
           value="string-length(cbc:TaxableAmount) &lt;= 15 and string-length(cbc:TaxableAmount) &gt;= 4"/>
    <param name="CIUS-VD-67_CONTEXT" value="cac:TaxTotal/cac:TaxSubtotal"/>
    <param name="CIUS-VD-67"
           value="string-length(cbc:TaxAmount) &lt;= 15 and string-length(cbc:TaxAmount) &gt;= 4"/>
    ...
    <param name="CIUS-VD-69"
           value="(string-length(cbc:ID) + string-length(cac:Attachment/cbc:EmbeddedDocumentBinaryObject/@filename)) &lt;= 60"/>
    ...
    <param name="CIUS-VD-83"
           value="string-length(cbc:PriceAmount) &lt;= 21 and string-length(cbc:PriceAmount) &gt;= 4"/>
    ...
    <param name="CIUS-VD-91_CONTEXT"
           value="cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode"/>
    ...
    <param name="CIUS-VD-97-1"
           value="not(cbc:EndpointID/@schemeID = ' PEC') or ( string-length(cbc:EndpointID) &gt;= 7  and string-length(cbc:EndpointID) &lt;= 256 )"/>
    <param name="CIUS-VD-97-2"
           value="not(cbc:EndpointID/@schemeID = ' IPA') or ( string-length(cbc:EndpointID) &lt;= 6 )"/>
    <param name="CIUS-VD-97-3"
           value="not(cbc:EndpointID/@schemeID = ' CodiceUfficio') or ( string-length(cbc:EndpointID) &lt;= 7 )"/>
    <param name="CIUS-VD-99_CONTEXT"
           value="//ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID"/>
    <param name="CIUS-VD-99"
           value="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'IT') or ( ( ( not(contains(normalize-space(.),' ')) and contains( ' RF01 RF02 RF03 RF04 RF05 RF06 RF07 RF08 RF09 RF10 RF11 RF12 RF13 RF14 RF15 RF16 RF17 RF18 RF19',concat(' ',normalize-space(.),' ') ) ) ) )"/>
