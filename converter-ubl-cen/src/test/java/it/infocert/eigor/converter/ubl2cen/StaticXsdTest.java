...
public class StaticXsdTest {
    ...
    public void shoudLoadTheOnlineXsdVersion() throws SAXException {
        XSDValidator xsdValidator = new XSDValidator(FileUtils.getFile("../converter-commons/src/main/resources/converterdata/converter-commons/ubl/xsd/UBL-Invoice-2.1.xsd"), ErrorCode.Location.UBL_IN);
