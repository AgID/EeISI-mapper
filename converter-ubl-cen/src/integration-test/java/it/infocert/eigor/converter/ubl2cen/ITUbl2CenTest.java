...
public class ITUbl2CenTest {
    ...
    public void setUp() throws ConfigurationException {
        ...
        EigorConfiguration conf = new PropertiesBackedConfiguration()
                ...
                .addProperty("eigor.converter.ubl-cen.cius", "classpath:converterdata/converter-commons/ubl/cius/schematron-xslt/EN16931-CIUS-IT-UBLValidation.xslt")
                ...
                .addProperty("eigor.converter.ubl-cen.xsd", "classpath:converterdata/converter-commons/ubl/xsdstatic/UBL-Invoice-2.1.xsd")
