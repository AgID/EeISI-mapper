...
<param name="InvoiceLine_Price" value="cac:CreditNoteLine/cac:Price"/>
<param name="InvoiceLine_OrderLineReference" value="cac:CreditNoteLine/cac:OrderLineReference"/>
<param name="InvoiceLine_Item_StandardItemIdentification" value="cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification"/>
<param name="InvoiceLine_Item_SellersItemIdentification" value="cac:CreditNoteLine/cac:Item/cac:SellersItemIdentification"/>
<param name="InvoiceLine_Item_OriginCountry" value="cac:CreditNoteLine/cac:Item/cac:OriginCountry"/>
<param name="InvoiceLine_Item_CommodityClassification_ItemClassificationCode" value="cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode"/>
<param name="InvoiceLine_Item_CommodityClassification" value="cac:CreditNoteLine/cac:Item/cac:CommodityClassification"/>
<param name="InvoiceLine_Item_BuyersItemIdentification" value="cac:CreditNoteLine/cac:Item/cac:BuyersItemIdentification"/>
<param name="InvoiceLine_Item_AdditionalItemProperty" value="cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty"/>
<param name="InvoiceLine_Item" value="cac:CreditNoteLine/cac:Item"/>
<param name="InvoiceLine_DocumentReference" value="cac:CreditNoteLine/cac:DocumentReference"/>
<param name="InvoiceLine_AllowanceCharge" value="cac:CreditNoteLine/cac:AllowanceCharge"/>
<param name="InvoiceLine" value="cac:CreditNoteLine"/>
<param name="Invoice_Root" value= "//cn:CreditNote"/>
