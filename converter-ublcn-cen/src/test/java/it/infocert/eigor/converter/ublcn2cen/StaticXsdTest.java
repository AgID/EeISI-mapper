...
public class StaticXsdTest {
    ...
    public static void setUp() throws SAXException {
        sut = new XSDValidator(FileUtils.getFile("../converter-commons/src/main/resources/converterdata/converter-commons/ublcn/xsdstatic/UBL-CreditNote-2.1.xsd"), ErrorCode.Location.UBLCN_IN);
    }
