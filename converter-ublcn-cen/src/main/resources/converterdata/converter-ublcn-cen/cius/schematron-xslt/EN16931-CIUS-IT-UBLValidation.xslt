...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EN16931 UBL CIUS IT">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EN16931 UBL CIUS IT</svrl:text>

<!--PATTERN CIUS-IT-->


	<!--RULE -->
<xsl:template match="//cn:CreditNote" mode="M7" priority="1047">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine" mode="M7" priority="1026">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:AllowanceCharge" mode="M7" priority="1025">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:AllowanceCharge" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:DocumentReference" mode="M7" priority="1024">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:DocumentReference" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item" mode="M7" priority="1023">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty" mode="M7" priority="1022">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:BuyersItemIdentification" mode="M7" priority="1021">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:BuyersItemIdentification" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:CommodityClassification" mode="M7" priority="1020">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:CommodityClassification" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode" mode="M7" priority="1019">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:OriginCountry" mode="M7" priority="1018">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:OriginCountry" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:SellersItemIdentification" mode="M7" priority="1017">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:SellersItemIdentification" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification" mode="M7" priority="1016">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:OrderLineReference" mode="M7" priority="1015">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:OrderLineReference" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine/cac:Price" mode="M7" priority="1014">
    <svrl:fired-rule context="cac:CreditNoteLine/cac:Price" />
